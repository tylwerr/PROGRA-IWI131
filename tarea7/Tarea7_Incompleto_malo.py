    ...
    while i2 < len(barcos) and flag2:
        ...
        if orientacion_barco2 == 1:
            ...
            while itera < largo_barco2:
                if tablero[fila_barco2+itera][columna_barco2] == 'O':

                    itera2 = 0
                    while itera2 < largo_barco2:
                        tablero[fila_barco2+itera2][columna_barco2] = 'X'
                        flag2 = False
                        itera2 += 1
            ...
            itera = 0
            while itera < largo_barco2:
                if tablero[fila_barco2][columna_barco2+itera] == 'O':

                    itera2 = 0
                    while itera2 < largo_barco2:
                        tablero[fila_barco2][columna_barco2+itera2] = 'X'
                        flag2 = False
                        itera2 +=1
